...
pub struct Module {
    #[serde(rename = "community.general.ilo_redfish_config")]
    pub module: Args,
}
...
pub struct Opt {
    #[serde(
        ...
        rename = "attribute_name"
    )]
    pub attribute_name: OptU<String>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "attribute_value"
    )]
    pub attribute_value: OptU<String>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "auth_token"

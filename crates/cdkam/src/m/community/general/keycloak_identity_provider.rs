...
pub struct Opt {
    ...
    pub add_read_token_role_on_create: OptU<bool>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "alias"
    ...
    pub authenticate_by_default: OptU<bool>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "config"

...
pub struct Module {
    #[serde(rename = "community.general.ipa_group")]
    pub module: Args,
}
...
pub struct Opt {
    ...
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "external_user"
    )]
    pub external_user: OptU<Vec<::serde_json::Value>>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "gidnumber"
    ...
    pub group: OptU<Vec<::serde_json::Value>>,
    #[serde(
        default = "OptU::default",
        skip_serializing_if = "OptU::is_unset",
        rename = "ipa_host"
